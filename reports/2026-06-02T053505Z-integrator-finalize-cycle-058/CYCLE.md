...
- **consumed-report frontmatter integrity** — all 4 marked `integrated_at` + `integration_commit: PLACEHOLDER_SHA` + `integration_notes` (SHA patched in the two-phase follow-up commit). PASS.
