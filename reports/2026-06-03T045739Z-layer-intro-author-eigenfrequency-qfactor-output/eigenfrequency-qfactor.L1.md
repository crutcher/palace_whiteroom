...
composes:
  ...
  - book/src/L4/eigenfreq_qfactor_reduce.md (rough-in — the per-mode scalar-ratio reduction; L1 sees the unfolded per-mode map)
l0_ground_truth:
...
|---|---|---|---|
| producing driver column | [`eigenmode.L1`](./eigenmode.L1.md) (driver feature column) | seed | `eigensolver.cpp:32-477` |
| eigenfrequency un-transform | [`eigenfreq_qfactor_reduce`](../L4/eigenfreq_qfactor_reduce.md) §Semantics (L4 home; L1 unfolded map) | rough-in | `eigensolver.cpp:430-439` |
| Q-factor κ participation | [`eigenfreq_qfactor_reduce`](../L4/eigenfreq_qfactor_reduce.md) §Semantics (L4 home; L1 unfolded map) | rough-in | `postoperator.cpp:1188-1203` |
