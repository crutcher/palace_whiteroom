...
Shape contract (bunsen-style; named records and axes; the three strata per [`state-stratification`](../concepts/state-stratification.md); the solution-space shape group `S` follows the named-shape-group convention of [`l4_calculus`](../design/l4_calculus.md) §1.2.1):
