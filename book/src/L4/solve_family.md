...
- **Law 1 (concatenation-homomorphism)** is the definitional list-homomorphism of `map` (strawman §3.7, `book/src/semantics/index.md:150-184`) — `map f (a ++ b) = map f a ++ map f b` — specialized to the fixed shared `op`. A syntactic identity, not a numerically-asserted axiom.
...
verified_against:
    ...
    verified_against:
      ...
      - citation: book/src/semantics/index.md:150-184
        verdict: supports
        audited_at: 2026-06-04T013000Z
