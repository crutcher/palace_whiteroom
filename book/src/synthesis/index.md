...
| [`iteration`](./iteration.md) | [Iteration & step combinators](../L4/iteration-combinators-intro.md) | `chebyshev`, `iterate_while`, `iterate_while_with_prev`, `krylov_step` (+ the iteration-clustering step-state carriers) | navigational (rendered) |
