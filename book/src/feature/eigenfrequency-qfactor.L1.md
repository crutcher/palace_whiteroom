...
composes:
  ...
  - book/src/L4/eigenfreq_qfactor_reduce.md (rough-in (test-coverage-bounded) — the per-mode scalar-ratio reduction; L1 sees the unfolded per-mode map; both folded per-mode scalar maps firm L1: eigenvalue-untransform c080 + participation_ratio c077)
l0_ground_truth:
