...
| capacitance reduction (Vⱼᵀ K Vᵢ) | [`gram_reduce`](../L4/gram_reduce.md) (`w = 1` voltage specialization) — folding L1 [`matrix-weighted-norm`](../L1/matrix-weighted-norm.md) (diagonal) / [`bilinear-form`](../L1/bilinear-form.md) (off-diagonal) | firm | `electrostaticsolver.cpp:95, 100-138` |
