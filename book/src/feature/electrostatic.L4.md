...
| capacitance reduction (Vⱼᵀ K Vᵢ) | [`gram_reduce`](../L4/gram_reduce.md) (`w = 1` voltage specialization) — folding L1 [`matrix_weighted_norm`](../L1/matrix_weighted_norm.md) (diagonal) / [`bilinear_form`](../L1/bilinear_form.md) (off-diagonal) | firm | `electrostaticsolver.cpp:95, 100-138` |
