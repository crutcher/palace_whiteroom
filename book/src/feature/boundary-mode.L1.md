...
edges:
  ...
  reference:
    ...
    - feature/waveguide-mode.L1           # SIBLING output-product cross-link — homes this driver's stage-(3) readout reduction; a reference, NOT a blocking constituent (OWN-COMPOSITION rule)
---
