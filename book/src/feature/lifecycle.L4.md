...
| dispatch → eigenmode / driven / transient columns | eigenmode.L4 / driven.L4 / transient.L4 *(forthcoming — not yet authored)* | not yet authored | `palace/main.cpp:264, 261, 273` |
