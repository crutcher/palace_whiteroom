...
| inductance reduction (Aⱼᵀ K Aᵢ / Iᵢ Iⱼ) | [`gram_reduce`](../L4/gram_reduce.md) (`w = 1/(IᵢIⱼ)` current-normalized specialization) — folding L1 [`matrix-weighted-norm`](../L1/matrix-weighted-norm.md) (diagonal, firm) / [`bilinear-form`](../L1/bilinear-form.md) (off-diagonal, firm) | firm | `magnetostaticsolver.cpp:108, 110-152` |
