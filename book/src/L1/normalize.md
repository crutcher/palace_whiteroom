...
- L1 anchors: `book/src/L1/nrm2.md` (firm; `β = √⟨x,x⟩`, real-valued output), `book/src/L1/scal.md` (firm; `û = scal(1/β, x)`, law 8 round-trip), `book/src/L1/matrix-weighted-norm.md` (firm, promoted cycle-091; the `normalize_B` norm constituent), `book/src/L1-L0/scal-mutation-rotation.md:48-49,141-147` (sub-pattern A names the `Normalize` rescale + defers this decision to this OQ).
