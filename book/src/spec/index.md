...
| [cg_preconditioning_framework](./slices/cg_preconditioning_framework.md) | L4 v0.2 | 2026-05-26 | L4 v0.2 self-tightening: capability-typed (op, pc_op) split via TrueOp<E> / PcAssemblyOp<E> brands; resolves L4 v0.1 open question on convention-vs-type role discipline. |
