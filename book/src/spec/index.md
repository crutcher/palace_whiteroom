...
| [GMRES](./slices/gmres.md) | L4 (slice v0.5) | 2026-05-26 | L4 v0.5 unifies entry and post-correction stop classifiers into a single `classify` with `Position = PreKrylov real | PostKrylov Krylov`, resolving the v0.4 open question. Surface narrows from 8 helpers to 7; `max_it`/`max_dim` read at exactly one site. |
