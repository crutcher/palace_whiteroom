...
|-------|---------------|--------------|--------------|
| [CG](./slices/cg.md) | L4 | 2026-05-25 | v0.3: L0/L1 audit pass; surfaces CheckDot partial-function guard and the (b·b)^{1/4} initial-residual quirk in the !B && initial_guess branch (likely Palace bug, preserved faithfully). |
