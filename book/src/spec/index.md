...
| [cg_preconditioning_framework](./slices/cg_preconditioning_framework.md) | L2 | 2026-05-26 | L1 invariant + four-axis variant absorption (krylov-method, pc-type, multigrid, scalar-field); L2 primitive composition naming constructed-operator-factory, solver-as-operator, complex-from-real-lift, finest-level-unwrap, counter-update. |
