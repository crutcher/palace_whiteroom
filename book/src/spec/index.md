...
| [GMRES](./slices/gmres.md) | L1 | 2026-05-26 | L0 cited to palace/linalg/iterative.cpp::GmresSolver::Mult and FgmresSolver::Mult; L1 form names GmresState and the restarted Arnoldi+incremental-LS recurrence; preconditioner side absorbed via apply_BA constructed operator; orthogonalization variant absorbed at primitive contract; cross-slice comparison with CG surfaces the shared BLAS-1/2 vocabulary. |
| [Orthogonalization (plane-rotation stream)](./slices/orthog.md) | L1 | 2026-05-26 | Plane-rotation stream entry-point: L0 cites GeneratePlaneRotation/ApplyPlaneRotation + GMRES driver; L1 names per-step replay+generate+apply+propagate procedure. L2/L3 deferred. |
...
| [cg_preconditioning_framework](./slices/cg_preconditioning_framework.md) | L4 | 2026-05-26 | Build-time vs run-time stratification at L4; KspParams/PcParams immutable, OpBinding set-once, Counters monadically threaded. Constructor-phase pure, body-phase in Solve E monad. Variant absorption (krylov-method, pc-type, multigrid, scalar-field) carries through as type-erased polymorphism. |
