...
- **CG / PCG**: `p_k = r_k + (β_k/β_{k-1})·p_{k-1}` for `k ≥ 1`, with `p_0 = r_0` (no `β_{-1}`). See the firm [`krylov_step` (CG instance)](../L2/krylov_step.md) + [`L4/krylov_step`](../L4/krylov_step.md) Form B.
...
- [`krylov_step` (CG instance)](../L2/krylov_step.md) — CG L4 v0.5 (firm-homed at [`L4/krylov_step`](../L4/krylov_step.md) Form B) was the first form to adopt the unrolling.
