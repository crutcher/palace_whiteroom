...
- [Iteration & step combinators](./L4/iteration-combinators-intro.md)
  ...
  - [iterate_while](./L4/iterate_while.md)
  - [iterate_while_with_prev](./L4/iterate_while_with_prev.md)
  - [krylov_step](./L4/krylov_step.md)
...
- [Operator application & introspection](./L3/operator-apply-intro.md)
  ...
  - [assemble_diagonal](./L3/assemble_diagonal.md)
- [Smoothers & projector gates](./L3/smoother-intro.md)
  - [chebyshev](./L3/chebyshev.md)
  - [divfree_projector](./L3/divfree_projector.md)
...
- [Elementwise & gate floors](./L2/elementwise-gate-floors-intro.md)
  - [assemble_diagonal](./L2/assemble_diagonal.md)
  - [divfree_projector](./L2/divfree_projector.md)
...
- [Constructed-operator gates](./L1/constructed-operator-gates-intro.md)
  ...
  - [divfree_projector](./L1/divfree_projector.md)
  - [eigsolve](./L1/eigsolve.md)
  - [floquet_correction](./L1/floquet_correction.md)
...
- [Krylov least-squares leaves](./L1/krylov-least-squares-intro.md)
  ...
  - [ls_update_column](./L1/ls_update_column.md)
