...
The theme does NOT cover the upstream gmres.md §L4 self-rotation itself — that was authored as the cycle-020 wave-1 lifter dispatch (recorded at the slice's §L4 v0.7 section, `gmres.md:673-747`); this theme is its L4>L3 post-condition for the FGMRES specialisation.

## L4 form (LHS)

The migrated FGMRES inner loop, as it appears under the now-firm `gmres.md` §L4 v0.7 form (the migrated form authored cycle-020 wave-1, `gmres.md:673-747`), parameterised on the FGMRES variant-axis collapse:
