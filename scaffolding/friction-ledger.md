...
last_observed: cycle-153
recurrence_count: 2
status: addressed
addressed_by: meta-150 (A–F scan codified) + meta-153 (E-grep widened to the date-less `meta-review #N` arm; the `## Context` orientation-vs-process distinction codified into the finalization-debulk skill)
---
```
